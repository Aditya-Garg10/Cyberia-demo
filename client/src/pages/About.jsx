...
import { HeroHighlightDemo } from "../components2/ui/Backgrond";

function About() {
  return (
    <div className="z-1000 bg-black bg-[url('./assets/AboutPage_Bg_Blurred.jpg')] bg-fixed bg-no-repeat bg-cover">
